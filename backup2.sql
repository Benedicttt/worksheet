...
--
-- Name: heroku_ext; Type: SCHEMA; Schema: -; Owner: u1gat6up8j31j
--

CREATE SCHEMA heroku_ext;


ALTER SCHEMA heroku_ext OWNER TO u1gat6up8j31j;
...
CREATE TABLE public.egg_collects (
    ...
    prima integer,
    craggs integer,
    big_small character varying,
    flooreggs integer,
    egg_width integer,
    deads_chick integer,
    deads_hen integer,
    water_ml_day integer,
    feed_g_day integer,
    hen_width integer
);
...
COPY public.egg_collects (id, day, month, year, prima, craggs, big_small, flooreggs, egg_width, deads_chick, deads_hen, water_ml_day, feed_g_day, hen_width) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.egg_collects_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.work_lists_id_seq', 148, true);
...
SELECT pg_catalog.setval('public.work_shift_schedule_days_id_seq', 43, true);
...
SELECT pg_catalog.setval('public.work_shift_schedules_id_seq', 43, true);
...
--
-- Name: SCHEMA heroku_ext; Type: ACL; Schema: -; Owner: u1gat6up8j31j
--
